...
const file_auth_service_proto_rawDesc = "" +
	"\n" +
	"\x12auth_service.proto\x12\x04auth\x1a\x15auth/auth_model.proto\x1a\x1bgoogle/protobuf/empty.proto\"i\n" +
	...
	"\n" +
	"DeleteUser\x12\x13.auth.DeleteRequest\x1a\x16.google.protobuf.EmptyB*Z(github.com/nuulun/contracts/auth/go;authb\x06proto3"
